...
const TOPICS = [
  ...
  action('action-dataset-region-touchup', 'Touch up a region of a dataset image',
    ['touch up', 'touchup', 'inpaint', 'region', 'brush', 'paint', 'mask',
     'jewelry', 'necklace', 'earrings', 'blemish', 'skin', 'makeup', 'remove',
     'klein', 'prompt', 'paint out', 'retouch', 'reset', 'dataset', 'lightbox'],
