...
const TOPICS = [
  ...
  { id: 'page-bank', kind: 'page', title: 'Image bank (triage)',
    keywords: ['bank', 'triage', 'import', 'folder', 'telegram', 'duplicates', 'blurry',
      'quality', 'cluster', 'person', 'sort', 'promote', 'unsorted'],
    guide: { chapter: 'using-the-app', anchor: 'the-image-bank-triage-a-big-folder' },
    app: { route: '/bank' } },
  { id: 'page-setup', kind: 'page', title: 'Setup wizard',
    keywords: ['setup', 'wizard', 'onboarding', 'install', 'connect', 'tools'],
